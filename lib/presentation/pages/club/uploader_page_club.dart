...
class UploaderPageClub extends StatefulWidget {
  const UploaderPageClub({super.key});

  @override
  State<UploaderPageClub> createState() => _UploaderPageClubState();
}

class _UploaderPageClubState extends State<UploaderPageClub> {
  int currentIndex = 0;
  int likeCount = 0;
  int dislikeCount = 0;
  ...
  Future<void> uploadFilesDesktop() async {
    ...
    for (final image in images.files) {
      ...
      final ref = FirebaseStorage.instance
          .ref('postClub/${name + DateTime.now().toString()}');
  ...
  Future<void> uploadFiles() async {
    ...
    for (final image in images) {
      final ref =
          FirebaseStorage.instance.ref('postClub/${DateTime.now().toString()}');
  ...
  Future<List<Reference>> loadImages() async {
    final ref = FirebaseStorage.instance.ref('postClub');
